...
impl FlightDataEncoderBuilder {
    ...
    where
        S: Stream<Item = Result<FlightDataItem>> + Send + 'static,
    {
        let Self {
...
pub struct FlightDataEncoder {
    /// Input stream
    inner: BoxStream<'static, Result<FlightDataItem>>,
    ...
    fn poll_next(
        ...
        loop {
            ...
            match item {
                ...
                Some(Ok(FlightDataItem::RecordBatch(batch))) => {
...
mod tests {
    ...
    use arrow::array::{builder, downcast_array, new_null_array, Array, DictionaryArray, GenericByteDictionaryBuilder, Int16Array, Int32Array, Int64Array, ListArray, ListBuilder, MapArray, StringArray, StringDictionaryBuilder, StructArray, StructBuilder, UInt32Array, UInt64Array, UInt8Array};
    use arrow::buffer::ScalarBuffer;
    use arrow::datatypes::{GenericStringType, Int32Type, UInt16Type, UnionFields};
